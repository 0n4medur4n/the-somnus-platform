...
@Module({
  imports: [HealthModule, VersionModule, NotificationModule, AuditModule, MaintenanceModule],
  providers: [
    ...
    // whose declared type is a `createZodDto` class and passes everything
    // else through untouched. Build plan §3.4: Zod is the single source
    // of truth for contracts.
