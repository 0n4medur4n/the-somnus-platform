# Production is a thin wrapper over the shared environment module: one
# composition, configured per environment. min-instances 0 is enforced inside the
# module (build plan §2 -- no warm instances even in production).
