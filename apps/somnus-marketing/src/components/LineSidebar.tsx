        ...
        {items.map((label, index) => (
          ...
          >
            ...
            <button
              ...
              className="relative inline-flex cursor-pointer items-baseline border-0 bg-transparent p-0 text-left leading-[1.2] [color:color-mix(in_srgb,var(--accent-color)_calc(var(--effect,0)*100%),var(--text-color))] [font-size:var(--font-size)] [transform:translateX(calc(var(--effect,0)*var(--max-shift)))] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--accent-color)]"
            >
              {showIndex && (
